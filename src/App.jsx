...
function App() {
  ...
  useEffect(()=>{
    ...
    setLocalStorageRead(true) // Indicating that the context has been read from the LocalStorage once (weather the values were there in the LocalStorage or not)
    return ()=>{}
  },[])
